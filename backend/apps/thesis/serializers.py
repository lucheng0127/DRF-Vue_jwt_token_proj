...
class ThesisLogSerializer(serializers.ModelSerializer):
    class Meta:
        model = ThesisLog
        fields = ['id', 'thesis', 'last_update_time', 'created_date', 'filename_cn', 'upload_times']
        read_only_fields = ['id', 'thesis', 'last_update_time', 'created_date', 'filename_cn', 'upload_times']
